...
export default function AboutMe() {
  ...
  const handleDownloadResume = () => {
    ...
    link.href = "/Meron Asnake cv.pdf";
    link.download = "/Meron Asnake cv.pdf";
    link.click();
  };
  ...
  return (
      ...
      <div id=" about" key="about" className="min-h-screen flex items-center justify-ceter p-4 bg-[#011806] text-white">
      <Head>
      ...
      <div className="w-full sm:w-[50%] lg:w-[30%] aspect-square relative rounded-full overflow-hidden border-8 border-gradient-to-r from-teal-400 to-lime-500 bg-gradient-to-r from-red-500 via-yellow-500 to-blue-500 shadow-xl">
            <div
              ...
              style={{ backgroundImage: "url('/Meri.JPG')" }}
            />
          </div>
  ...
  <a
    href="#contact"
    className="bg-green-500 hover:bg-red-800 text-white font-bold py-3 px-6 rounded w-full sm:w-auto text-lg sm:text-xl text-center"
  >
    Connect
  </a>
  ...
  <button
    ...
    className="bg-[#093a0b] hover:bg-gray-500 text-white font-bold py-3 px-6 rounded w-full sm:w-auto text-lg sm:text-xl border-2 border-white"
  >
    Resume
  </button>
</div>
